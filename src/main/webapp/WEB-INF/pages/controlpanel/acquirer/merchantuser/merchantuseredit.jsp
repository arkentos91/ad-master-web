    ...
    <head>
        ...
        <script>
            ...
            function editMerchantUser(keyval) {
                $.ajax({
                    url: '${pageContext.request.contextPath}/findMerchantUser.action',
        ...
        <div class="ali-modal">
            <div class="ali-modal-body">
                <div class="ali-form">
                    ...
                    <s:form id="merchantuseredit" method="post" action="MerchantUser"  theme="simple" cssClass="form">   
                            ...
                            <div class="col-md-12">
                                <div class="form-group ali-margin f-right">
                                    <sj:submit 
                                        ...
                                        onClick="cancelData()"
                                        />                        
                                    <s:url action="updateMerchantUser" var="updateturl"/>
                                    <sj:submit
                                        button="true"
                                        value="Update"
                                        href="%{updateturl}"
