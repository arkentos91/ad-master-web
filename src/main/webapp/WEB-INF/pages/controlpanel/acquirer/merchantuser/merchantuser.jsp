...
//                $led.load("detailMerchantUser.action?username=" + $led.data('username'));
                $led.load("changepasswordMerchantUser.action?username=" + $led.data('username'));
            });
            ...
            function editformatter(cellvalue) {
                return "<a href='#/' title='Edit' onClick='javascript:editMerchantUserInit(&#34;" + cellvalue + "&#34;)'><img class='ui-icon ui-icon-pencil' style='display: block;margin-left: auto;margin-right: auto;'/></a>";
            }

            function editMerchantUserInit(keyval) {
    ...
    <body style="">
        ...
        <div class="ali-body f-right ali-header-text"> 
            ...
            <s:set var="vpasswordreset"><s:property value="vpasswordreset" default="true"/></s:set>
                ...
                <div class="ali-form">
                <s:form cssClass="form" id="systemuseradd" method="post" action="MerchantUser" theme="simple" >

                    <s:hidden id="oldvalue" name="oldvalue" ></s:hidden>
                    <s:url var="addurl" action="viewpopupMerchantUser"/>
                    <s:url var="updateurl" action="UpdateMerchantUser"/>
                ...
                <sj:dialog                                     
                    ...
                    autoOpen="false" 
                    modal="true" 
                    title="Merchant User Change Password"
