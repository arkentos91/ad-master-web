<%-- 
    Document   : headmerchantcsv
    Created on : Sep 26, 2016, 6:29:07 PM
    Author     : jayana_i
--%>
...
<html>
    <head>
        ...
        <script>
            ...
            function todo() {
                form = document.getElementById('merchantcsv');
                form.action = 'templateMerchantCustomer';
                form.submit();
            }
    ...
    <body>
        ...
        <s:form id="merchantcsv" method="post"   theme="simple" cssClass="form" >
                ...
                <div class="row row_popup form-inline">
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <div class="form-group" style=" margin-left: 0px;margin-right: 10px;">
                            <s:url action="uploadMerchantCustomer" var="uploadurl"/>
                            <sj:submit 
                                button="true"
                                href="%{uploadurl}"
                                value="Upload"
