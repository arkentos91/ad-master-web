    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $.subscribe('openviewtasktopage', function (event, data) {
                ...
                $led.html("Loading..");
                $led.load("detailTerminal.action?id=" + encodeURIComponent($led.data('id')));
        ...
        <div class="ali-body f-right ali-header-text">
            ...
            <div class="ali-table">
                ...
                <sjg:grid
                    ...
                    <sjg:gridColumn name="id" index="CP.id" title="Edit" width="40" align="center" sortable="false" formatter="editformatter" hidden="#vupdatelink" />
                    <sjg:gridColumn name="id" index="CP.id" title="Delete" width="40" align="center" sortable="false" formatter="deleteformatter" hidden="#vdelete" />  
                    <sjg:gridColumn name="id" index="CP.id" title="Reset Status" width="80" align="center" sortable="false" formatter="resetformatter" hidden="#vreset" />
                    <sjg:gridColumn name="id" index="CP.TERMINALID" title="Terminal ID"  sortable="true" />
