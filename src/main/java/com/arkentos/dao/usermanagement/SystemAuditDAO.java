...
import com.arkentos.util.common.ExcelCommon;
...
//            queryCount = setDatesToQuery(queryCount, inputBean, session);
                ...
                for (int i = 0; i < numberOfTimes; i++) {
                    ...
                    if (objectArrList.size() > 0) {
                        ...
                        for (Object[] objArr : objectArrList) {
                            ...
                            try {
                                // dataBean.setTransactionID(txnBean.getTransactionid().toString());
                                dataBean.setUser(objArr[8].toString());
                                if(objArr[8].equals("")){
                            ...
                            try {
                                // dataBean.setTransactionID(txnBean.getTransactionid().toString());
                                dataBean.setLastUpdatedDate(objArr[9].toString());
                                if(objArr[9].equals("")){
     ...
     private String makeWhereClauseForExcel(AuditSearchDTO inputBean) throws ParseException {
        ...
        if (inputBean.getFdate()!= null && !inputBean.getFdate().isEmpty()) {
            where += " and g.LASTUPDATEDTIME >='" + inputBean.getFdate() + "'";
        }
     ...
     private SXSSFWorkbook createExcelTopSection(AuditSearchDTO inputBean) throws Exception {
        ...
        cell.setCellValue("System Audit Report");
        cell.setCellStyle(fontBoldedUnderlinedCell);
        ...
        cell.setCellValue(Common.replaceEmptyorNullStringToNA(inputBean.getFdate()));
        ...
        cell = row.createCell(1);
        cell.setCellValue(Common.replaceEmptyorNullStringToNA(inputBean.getTdate()));
        cell.setCellStyle(ExcelCommon.getAligneCell(workbook, null, XSSFCellStyle.ALIGN_RIGHT));
        ...
        cell = row.createCell(1);
//        cell.setCellValue(Common.replaceEmptyorNullStringToNA(inputBean.getSection()));
        if (inputBean.getSdblpage()!= null && !inputBean.getSdblpage().isEmpty()) {
        ...
        cell = row.createCell(1);
//        cell.setCellValue(Common.replaceEmptyorNullStringToNA(inputBean.getSdblpage()));
        if (inputBean.getSdblpage()!= null && !inputBean.getSdblpage().isEmpty()) {
        ...
        cell = row.createCell(1);
//        cell.setCellValue(Common.replaceEmptyorNullStringToNA(inputBean.getTask()));
        if (inputBean.getTask()!= null && !inputBean.getTask().isEmpty()) {
        ...
        cell = row.createCell(1);
        cell.setCellValue(Common.replaceEmptyorNullStringToNA(inputBean.getUser()));
        cell.setCellStyle(ExcelCommon.getAligneCell(workbook, null, XSSFCellStyle.ALIGN_RIGHT));
