...
public class CommonVarList {
    ...
    public static final String STATUS_ACTIVE_DES = "Active";
    public static final String STATUS_YES = "YES";
    public static final String STATUS_NO = "NO";
    
    public static final String STATUS_SHORTLIST = "SHORT";
   
   
    
    public static final String STATUS_SENT_TO_QUEUE = "QUED";
    public static final String STATUS_CATEGORY_GENERAL = "DEF";
    public static final String STATUS_CATEGORY_INTERVIEW = "HRINT";
    ...
    public static final String STATUS_DEACTIVE_DES = "Deactive";
    ...
    public static final String REPORT_BML_ADD_HEADER = "Maldives";
    public static final String REPORT_BML_ADD = "Bank of Maldives Building, 11 Boduthakurufaanumagu, KAAFU, MALE'";
    public static final String REPORT_BML_TEL = "+9603322948";
    public static final String REPORT_SBML_MAIL = "support@bml.com.mv";
    ...
    public static final String STATUS_MONITOR_REFRESH_CODE = "51";
    public static String LDAP_URL  ;
    public static String LDAP_CREDENTIALS ;
    public static String LDAP_CONFIG_FILE_PATH = "C:/BML_LDAP/Config/LDAPConfig.xml";
    
    public static HashMap<String, String> MESSAGESMAP = new HashMap<String, String>();
    
   
    
    public static final int EOD_CONFIGURATION_ID = 1;
}
