...
public class Sectionpage  implements java.io.Serializable {
    ...
    public Sectionpage(SectionpageId id, Page page, Section section, Userrole userrole) {
        this.id = id;
        this.page = page;
        this.section = section;
        this.userrole = userrole;
    }
    public Sectionpage(SectionpageId id, Page page, Section section, Userrole userrole, String lastupdateduser, Date lastupdatedtime, Date createtime) {
       this.id = id;
       this.page = page;
       this.section = section;
       this.userrole = userrole;
    ...
    @AttributeOverrides( {
        @AttributeOverride(name="userrolecode", column=@Column(name="USERROLECODE", nullable=false, length=4) ), 
        @AttributeOverride(name="sectioncode", column=@Column(name="SECTIONCODE", nullable=false, length=4) ), 
        @AttributeOverride(name="pagecode", column=@Column(name="PAGECODE", nullable=false, length=4) ) } )
